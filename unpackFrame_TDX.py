...
def unpack(hdf5, slcname, prefix='TSX'):
    '''
    Unpack HDF5 to binary SLC file.
    '''
    from isceobj.Sensor.TanDEMX import TanDEMX

    fname = glob.glob(os.path.join(hdf5,'{0}1_SAR__SSC*/{0}1*.xml'.format(prefix)))[0]
...
if __name__ == '__main__':
    ...
    unpack(inps.h5dir, inps.slcdir+'_TSX', prefix='TSX')
    unpack(inps.h5dir, inps.slcdir+'_TDX', prefix='TDX')
